...
import tiktoken
from model.gpt_model import generate_text_simple
...
# ─────────────────────────────────────────────
# Advanced generation with temperature & top-k
# ─────────────────────────────────────────────
...
def train_model_simple(model, train_loader, val_loader, optimizer, device,
    ...
    """
    Simple training loop for the GPT model.
    ...
    Args:
        ...
        start_context : seed text to generate samples
...
def plot_losses(epochs_seen, tokens_seen, train_losses, val_losses):
    ...
    plt.show()
    print("Loss plot saved as loss-plot.png")